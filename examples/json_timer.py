...
from rusty_logger import Logger, LogLevel, LogConfig, LogFileConfig, JsonConfig
...
rust_result = timeit.timeit(stmt='rust_logger.info("test info")', globals=globals(), number=1_000)
